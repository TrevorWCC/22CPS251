package com.ebookfrenzy.contactsP22.ui.main
...
import com.ebookfrenzy.contactsP22.Product
import androidx.fragment.app.viewModels

import java.util.*

import com.ebookfrenzy.contactsP22.databinding.MainFragmentBinding
...
class MainFragment : Fragment() {
    ...
    private fun listenerSetup() {
        ...
        binding.addButton.setOnClickListener {
            ...
            val number = binding.productQuantity.text.toString()

            if (name != "" && number != "") {
                val contact = Product(name, Integer.parseInt(number))
